...
var setGlobal$3 = function (key, value) {
  try {
    defineProperty(global$h, key, { value: value, configurable: true, writable: true });
  } catch (error) {
    global$h[key] = value;
  } return value;
};
...
const usePermitByRole = () => {
  ...
  const checkAccess = useCallback(_ref => {
    let {
      allowedRoles
    } = _ref;

    if ((allowedRoles === null || allowedRoles === void 0 ? void 0 : allowedRoles.length) > 0) {
